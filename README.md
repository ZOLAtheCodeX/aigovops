...
| [system-event-logging](skills/system-event-logging/SKILL.md) | System-operational event log schema, retention policy, traceability structure (EU AI Act Article 12, Article 19, Article 26(6), ISO/IEC 42001:2023 Annex A Control A.6.2.8, NIST AI RMF MEASURE 2.8) | 0.1.0 |
| [explainability-documentation](skills/explainability-documentation/SKILL.md) | Dedicated explainability documentation (NIST AI RMF MEASURE 2.9, EU AI Act Article 86, ISO/IEC 42001:2023 Annex A Control A.8.2, UK ATRS Section Tool details) | 0.1.0 |
| [genai-risk-profile](skills/genai-risk-profile/SKILL.md) | NIST AI 600-1 (July 2024) Generative AI Profile 12-risk catalogue operationalization with NIST AI RMF subcategory mapping per Appendix A, EU AI Act Articles 50 and 55, and California SB 942 + AB 2013 + AB 1008 cross-references | 0.1.0 |
| [cascade-impact](skills/cascade-impact/SKILL.md) | Cascade impact analysis. Trigger-to-downstream-action registry served by the cascade-impact-analyzer plugin, covering framework changes, inventory updates, risk register events, SoA status, gap detection, certification readiness, metrics breaches, nonconformities, serious incidents, post-market drift, supplier changes, internal audit findings, management review closure, GPAI systemic-risk designation, oversight gaps, disparate impact, and evidence-bundle events | 0.1.0 |
| [certification-path](skills/certification-path/SKILL.md) | Certification path planning. Journey layer above certification-readiness. Produces milestone schedule, risk-weighted remediation sequencing, capacity-aware packing, and recertification triggers (ISO/IEC 42001:2023 Clauses 9.2, 9.3, 10.1; EU AI Act Articles 40, 43; Colorado SB 205 Section 6-1-1703(3); NYC LL144 Final Rule Section 5-301) | 0.1.0 |
...
| [system-event-logger](plugins/system-event-logger/) | System-operational event log schema, retention policy, biometric Article 12(3) field check, and traceability coverage map for EU AI Act Article 12, Article 19, Article 26(6), ISO/IEC 42001:2023 Annex A Control A.6.2.8, and NIST AI RMF MEASURE 2.8 (JSON + Markdown + CSV) | 0.1.0 |
| [explainability-documenter](plugins/explainability-documenter/) | Dedicated explainability documentation artifact for NIST AI RMF MEASURE 2.9, EU AI Act Article 86, ISO/IEC 42001:2023 Annex A Control A.8.2, and UK ATRS Section Tool details with model-type classification, scope and audience coverage, Art. 86 readiness, and limitations transparency assessment (JSON + Markdown + CSV) | 0.1.0 |
| [genai-risk-register](plugins/genai-risk-register/) | NIST AI 600-1 (July 2024) Generative AI Profile 12-risk catalogue operationalized as a dedicated GenAI risk register with per-risk NIST AI RMF subcategory mapping, EU AI Act Article 50 + Article 55 cross-references, California SB 942 + AB 2013 + AB 1008 cross-references, residual-risk logic checks, and high-residual escalation flagging (JSON + Markdown + CSV) | 0.1.0 |
| [eu-conformity-assessor](plugins/eu-conformity-assessor/) | Consumer plugin. EU AI Act Article 43 conformity procedure selection, Annex IV technical documentation completeness check against the evidence bundle, Article 17 QMS attestation, Annex VI internal control or Annex VII notified body routing, Article 47 EU declaration of conformity template, Article 48 CE marking check, Article 49 EU database registration check, Article 22 authorised representative check (JSON + Markdown + CSV) | 0.1.0 |
| [certification-path-planner](plugins/certification-path-planner/) | Consumer plugin. Journey layer above certification-readiness. Emits a milestone-based path plan with risk-weighted remediation sequencing, capacity-aware packing, per-remediation action-executor ActionRequest emission, and recertification triggers for ISO surveillance, NYC LL144 annual re-audit, Colorado SB 205 annual impact-assessment refresh, and EU harmonised-standards review (JSON + Markdown + CSV) | 0.1.0 |
| [cascade-impact-analyzer](plugins/cascade-impact-analyzer/) | Cascade impact analysis. Given a trigger event (regulatory change, risk register update, threshold breach, serious incident), computes the tree of downstream actions across the AIGovOps plugin catalogue with per-action authority, hop-count depth, and STYLE.md citations (JSON + Markdown + CSV) | 0.1.0 |
