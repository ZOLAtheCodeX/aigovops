...
| [certification-path](certification-path/SKILL.md) | Certification path planning. Journey layer above certification-readiness. Consumes a readiness snapshot and produces a milestone schedule with risk-weighted remediation sequencing, capacity-aware packing, per-remediation action-executor ActionRequests, and recertification triggers (ISO/IEC 42001:2023 Clauses 9.2, 9.3, 10.1; EU AI Act Articles 40, 43; Colorado SB 205 Section 6-1-1703(3); NYC LL144 Final Rule Section 5-301) | 0.1.0 | released |
| [cascade-impact](cascade-impact/SKILL.md) | Cascade impact analysis. Trigger-to-downstream-action registry served by the cascade-impact-analyzer plugin (22 seeded cascades covering framework, inventory, risk, SoA, gap, readiness, metrics, nonconformity, incident, post-market, supplier, audit, management review, GPAI, oversight, bias, and evidence-bundle triggers) | 0.1.0 | released |
