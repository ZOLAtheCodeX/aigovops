...
| [internal-audit-planner](internal-audit-planner/) | ISO 42001 Clause 9.2 internal audit programme + schedule + criteria + impartiality assessment (JSON + Markdown + CSV) | 0.1.0 |
...
| [certification-readiness](certification-readiness/) | Consumer plugin. Graduated readiness verdict against a target certification with evidence completeness, gaps, blockers, and curated remediations (JSON + Markdown + CSV) | 0.1.0 |
| [post-market-monitoring](post-market-monitoring/) | EU AI Act Article 72, ISO/IEC 42001:2023 Clause 9.1, NIST MANAGE 4.1 / 4.2 post-market monitoring plan with per-dimension rows, trigger catalogue, Chapter III alignment, continuous-improvement loop, and review schedule (JSON + Markdown + CSV) | 0.1.0 |
...
| [robustness-evaluator](robustness-evaluator/) | Point-in-time robustness evaluation record for EU AI Act Article 15, ISO/IEC 42001 Annex A Control A.6.2.4, and NIST AI RMF MEASURE 2.5 / 2.6 / 2.7 with adversarial-posture aggregation and lifecycle trend (JSON + Markdown + CSV) | 0.1.0 |
| [bias-evaluator](bias-evaluator/) | Standard fairness metrics (selection rate, impact ratio, demographic parity difference, equalized odds difference, predictive parity difference, statistical parity difference) per protected-attribute group with NYC LL144 four-fifths rule, EU AI Act Article 10(4), Colorado SB 205 Section 6-1-1702(1), Singapore MAS Veritas, ISO/IEC 42001 A.7.4, and NIST MEASURE 2.11 jurisdictional rule application (JSON + Markdown + CSV) | 0.1.0 |
| [system-event-logger](system-event-logger/) | EU AI Act Article 12 (automatic recording of events), Article 19 (log retention minimum 6 months), Article 26(6) (deployer log duty), ISO/IEC 42001:2023 Annex A Control A.6.2.8 (AI system event logging), and NIST AI RMF MEASURE 2.8 system-operational event log schema, retention policy, biometric Article 12(3) field check, and traceability coverage map (JSON + Markdown + CSV) | 0.1.0 |
